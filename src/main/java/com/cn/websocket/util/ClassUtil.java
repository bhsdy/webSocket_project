...
public class ClassUtil {
	...
	public static void main(String[] args) throws Exception {
		List<Class<?>> clazzList = getClasses("com.waben");
		for(Class<?> clazz : clazzList) {
			RestController annotation = clazz.getAnnotation(RestController.class);
			RequestMapping annotation2 = clazz.getAnnotation(RequestMapping.class);
			if(annotation != null && annotation2 != null) {
				...
				for(Method method : methods) {
					...
					if(annotation3 != null) {
						...
						method.invoke(clazz.newInstance(), 1, 2, new Object());
					}
				}
			}
		}
